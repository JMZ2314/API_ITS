    ...
    def post(self, request):
        ...
        try:
            ...
            if(serializer.is_valid()):
                ...
                return Response({'success': True, 'message': "Tu sugerencia fue registrada exitosamente", 'data': section_created , 'status' : status.HTTP_200_OK }, status= status.HTTP_200_OK)
            else:
